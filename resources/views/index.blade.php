                      ...
                      <a href="/cats/{{$cat->id}}">
                         <div class="Categories-box">
                               <div class="our-services settings">
                                  ...
                                  <h4 class="Categorie-Title">{{$cat->name}}</h4>
                                  <p class="Categorie-Text">{{$cat->text}}</p>
                               </div>
                          </div>
                      </a>
                   </div>
                                ...
                                @endif
                                    <a href="{{ route('show-product', $prod->id) }}" class="content">
                                        ...
                                        <div class="background-image"
                                            style="background-image: url('https://wenfee.com/jasmine/thenewwenfee/storage/app/public/{{ $prod->image}}');">
                                        </div>
                   ...
                   <div class="Recipes-Slider">
                    ...
                    <div class="ft-recipe">
                            ...
                            <div class="ft-recipe__content">
                                ...
                                <p class="description">
                                        {{$recipe->short_desc}}</p>
                                <footer class="content__footer"><a href="/recipe/{{$recipe->slug}}">View Recipe</a></footer>
                            </div>
                    </div>
